package ui
{
	 ...
	 */
	public class YoloSkin extends PunkSkin
	{
		/**
		 * The asset to use for the skin images
		 */
		[Embed(source="../res/images/button.png")] protected const I:Class;
		 ...
		 */
		public function YoloSkin(roundedButtons:Boolean = true, passwordField:int = 2, textArea:int = 0, textField:int = 1, windowCaption:int = 0, windowBody:int = 0)
		{
			super();
			...
			// #WhatTheFuckIsWrongWithTheStarForceFont
			punkButton = new PunkSkinButtonElement(gy(0, by), gy(16, by), gy(32, by), gy(0, by), { color: 0xFFFFFF, inactiveColor: 0x666666, size: 16 } );
